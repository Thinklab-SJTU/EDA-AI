...
class MultiModel(BaseModel):
    """ This class implements the bcGAN(ResNet) model, for learning a mapping from input images to output images given paired
    data.
    ...
    def backward_G(self):
        ...
        self.loss_G_GAN = (self.criterionGAN(pred_fake, True) + self.criterionGAN(pred_c, True)) * 0.5
        # Second, G(A) = B
