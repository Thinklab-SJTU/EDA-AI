...
# adjacent terminal settings
enable_adjacent_terminal=0
input_adjacent_terminal_mask=0
use_adjacent_terminal_constraint=1
reward_weight_adjacent_terminal=0.5


# adjacent block settings
enable_adjacent_block=0
input_adjacent_block_mask=1
use_adjacent_block_constraint=1
merge_adjacent_block_mask=sum
# merge_adjacent_block_mask=max
reward_class_adjacent_block=0
reward_weight_adjacent_block=0.5


# thermal optimization
enable_thermal=0
input_thermal_mask=1
input_power_mask=1
reward_weight_thermal=0.5
...
nohup python -u main.py \
    ...
    --reward_weight_adjacent_terminal ${reward_weight_adjacent_terminal} \
    --reward_weight_adjacent_block ${reward_weight_adjacent_block} \
    --reward_class_adjacent_block ${reward_class_adjacent_block} \
    ...
    --input_adjacent_terminal_mask ${input_adjacent_terminal_mask} \
    --input_adjacent_block_mask ${input_adjacent_block_mask} \
    --add_virtual_block ${add_virtual_block} \
    --merge_adjacent_block_mask ${merge_adjacent_block_mask} \
    --enable_adjacent_terminal ${enable_adjacent_terminal} \
    --use_adjacent_terminal_constraint ${use_adjacent_terminal_constraint} \
    --use_alignment_constraint ${use_alignment_constraint} \
    --enable_adjacent_block ${enable_adjacent_block} \
    --use_adjacent_block_constraint ${use_adjacent_block_constraint} \
    --enable_thermal ${enable_thermal} \
    --input_thermal_mask ${input_thermal_mask} \
    --input_power_mask ${input_power_mask} \
    --reward_weight_thermal ${reward_weight_thermal} \
    --ambient_temperture ${ambient_temperture} \
    ${additional_args} \
